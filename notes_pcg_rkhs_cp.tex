...
$A_{0,A}=(Z^\top Z)\otimes I_n + \lambda(I_r\otimes K^{-1})$ (or scaled by $\alpha=q/N$). Since this is a Kronecker sum, it diagonalizes in the eigenbases of $Z^\top Z$ and $K$ with eigenvalues $\sigma_a + \lambda/\lambda_b$.
